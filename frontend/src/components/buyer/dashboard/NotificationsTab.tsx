...
export const NotificationsTab = () => {
    const { data, isLoading, isError, markOne, markAll } = useNotifications();
                    ...
                    {notifications.map((n: any) => (
                        <div
                            ...
                            className={cn(
                                ...
                                !n.read && "after:content-[''] after:absolute after:left-0 after:top-0 after:bottom-0 after:w-1 after:bg-[#1A1A1A]"
                            )}
                        >
                            <div className="mt-1">
