...
export const HeroSection = () => (
    <section className="relative min-h-[80vh] w-full flex flex-col px-6 lg:px-12 py-12">
        ...
        <div className="flex-grow grid grid-cols-1 md:grid-cols-12 gap-12">
            <div className="md:col-span-7 relative group overflow-hidden bg-[#EAE8E2]">
                ...
                <img src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&q=80&w=1200" alt="Editorial" className="absolute inset-0 w-full h-full object-cover mix-blend-multiply opacity-80 group-hover:scale-105 transition-transform duration-1000" />
                <div className="absolute bottom-12 left-12 bg-[#FDFCF8] p-8 max-w-sm border border-[#1A1A1A]/10 shadow-2xl">
                    <span className="text-[9px] font-bold uppercase tracking-[0.3em] opacity-40 mb-4 block text-left">New Collection</span>
                    <h1 className="text-4xl leading-[1.1] font-heading font-medium italic text-left">
            ...
            <div className="md:col-span-5 flex flex-col justify-center lg:pr-12 text-left">
                <div className="max-w-md">
                    <h3 className="text-6xl lg:text-7xl leading-[0.85] mb-12 font-heading font-light italic">
                        Best <br /> Selection <br /> <span className="font-black not-italic lg:ml-12 text-[#1A1A1A]">For All.</span>
                    </h3>
                    <p className="text-sm leading-relaxed text-[#1A1A1A]/60 mb-12 font-light tracking-wide max-w-xs">
