...
export const CustomToasterContent: React.FC = () => (
    <Toaster position="top-right" toastOptions={{ duration: 4000 }}>
        {(t) => {
            ...
            const isInfo = (t as any).variant === 'info';

            return (
                <div className={cn(
                    "flex items-stretch min-w-[320px] bg-[#1A1A1A] border-l-4 shadow-[20px_20px_60px_rgba(0,0,0,0.3)] transition-all duration-300",
                    ...
                    <div className="flex-1 p-4">
                        <p className="text-[11px] font-bold uppercase tracking-widest text-[#FDFCF8] leading-relaxed">
...
export const riftToast = {
    ...
    info: (msg: string) => toast(msg, { variant: 'info' } as any),
