...
export const ResetPasswordPage: React.FC = () => {
  ...
  const [status, setStatus] = useState<"idle" | "updating" | "success">(
    "success",
  );
  ...
  const handleReset: SubmitHandler<FieldValues> = async (data) => {
            ...
            >
              ...
              <form onSubmit={handleSubmit(handleReset)} className="space-y-6">
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    {confirmPassword && password !== confirmPassword && (
                      <p className="text-[8px] font-bold text-red-600 uppercase tracking-widest mt-2 px-1">
                        Sequence Mismatch
                      </p>
                    )}
                  </div>
                ...
                >
                  <span
                    className={
                      status === "updating" ? "opacity-0" : "opacity-100"
                    }
                  >
                    Set New Password
                  </span>
              ...
              <div className="p-6 bg-[#1A1A1A]/5 border border-[#1A1A1A]/5 flex gap-4">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[8px] font-bold uppercase tracking-widest opacity-30 leading-normal">
                    Update will terminate all active sessions across registered
                    devices.
                  </p>
                </div>
              </div>
