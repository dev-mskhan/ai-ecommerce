  ...
  return (
    <div className="min-h-screen bg-[#FDFCF8] flex items-center justify-center p-6">
      <div className="max-w-md w-full">
        <Link to="/login" className="flex justify-center gap-2 text-[10px] font-bold uppercase tracking-widest opacity-40 hover:opacity-100 mb-12 transition-all group">
            ...
            >
              <div>
                <h1 className="text-4xl font-heading font-black italic tracking-tighter uppercase mb-4">
                  Password <br /> <span className="not-italic font-sans text-sm tracking-[0.5em] font-bold opacity-40">Recovery</span>
                </h1>
              ...
              <form onSubmit={handleSubmit(handleSend)} className="space-y-4">
                <div className="space-y-2">
                  <label className="text-[9px] font-bold uppercase tracking-[0.2em] opacity-40 px-1">Email</label>
                  <div className="relative group">
                    ...
                    />
                    <Mail size={14} className="absolute right-5 top-1/2 -translate-y-1/2 opacity-20 pointer-events-none" />
                  </div>
                  {errors.email && <Text variant="error">{errors.email.message as string}</Text>}
                </div>
