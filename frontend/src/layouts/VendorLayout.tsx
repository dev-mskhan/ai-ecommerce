...
const NAV_ITEMS = [
  ...
  { label: 'Revenue', icon: DollarSign, path: '/vendor/revenue' },
...
export const VendorLayout: React.FC = () => {
  ...
  // Get initials from store name or email
  ...
  return (
    <div className="flex h-screen bg-[#FDFCF8] overflow-hidden text-[#1A1A1A]">
              ...
              <Link
                ...
                className={cn(
                  ...
                  isActive
                    ...
                    : 'opacity-40 hover:opacity-80 hover:bg-[#FDFCF8]/5',
                )}
              >
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        ...
        {/* Topbar */}
        <header className="h-20 bg-[#FDFCF8]/90 backdrop-blur-md border-b border-[#1A1A1A]/10 flex items-center justify-between px-6 md:px-10 flex-shrink-0">
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <div className="relative" ref={notifRef}>
              ...
              {/* Dropdown */}
              {isNotifOpen && (
                <div className="absolute right-0 top-12 w-80 bg-[#FDFCF8] border border-[#1A1A1A]/10 shadow-lg z-50">
                    ...
                    {notifications.length === 0 ? (
                      ...
                      notifications.slice(0, 8).map((n: any) => (
                        <button
                          ...
                          className={cn(
                            'w-full text-left px-5 py-4 border-b border-[#1A1A1A]/5 hover:bg-[#EAE8E2] transition-colors',
